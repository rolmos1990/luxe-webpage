                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        <li className="menu-item-has-children">
                                            ...
                                            {/* <ul className="sub-menu">
                                                <li><Link onClick={ClickHandler}  href="/">Home style 100</Link></li>
                                                <li><Link onClick={ClickHandler} href="/home-2">Home style 200</Link></li>
                                                <li><Link onClick={ClickHandler} href="/home-3">Home style 300</Link></li>
                                            </ul> */}
                                        </li>
